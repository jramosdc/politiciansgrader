<?php
		...
		{ 
			...
			public static function set_page_details( $object, $condition='', $order_field = '', $order_type = '', $page_size = 0) {
				...
				if($_SERVER['QUERY_STRING'] == 'component=shipping-charge&action=list'){
					
					self::$page_size = DEFAULT_PAGE_SIZE_SHIPPING;	
				}
				else
				{
...
?>
									<a href="#" onclick="javascript:set_current_page('<?php echo $intfirst_page_js_parameter; ?>');"><img src="<?php echo ADMIN_THEME; ?>images/arrow_first_1_disabled.gif" alt="" /></a>
<?php
								}
								else {
?>
...
?>
									<a href="#" onclick="javascript: set_current_page('<?php echo $intprevious_page_js_parameter; ?>');"><img src="<?php echo ADMIN_THEME; ?>images/arrow_back_disabled.gif" alt="" /></a>
<?php
								}
								else {
?>
...
?>
								<a href="#" onclick="javascript: set_current_page('<?php echo $intnext_page_js_parameter; ?>'); "><img src="<?php echo ADMIN_THEME; ?>images/arrow_next_disabled.gif" alt="" /></a>
<?php
								}
								else {
?>
...
?>
								<a href="#" onclick="javascript: set_current_page('<?php echo $intlast_page_js_parameter; ?>');"><img src="<?php echo ADMIN_THEME; ?>images/arrow_last_1_disabled.gif" alt="" /></a>
<?php
								}
								else {
?>
...
?>
							...
							<td align="left" valign="top">
								<select name="selpage" id="selpage" onchange="javascript:set_current_page(this.value);" class="paging-select">
<?php
									for ( $intcounter = 0; $intcounter < $inttotal_page; $intcounter++ ) {
?>
